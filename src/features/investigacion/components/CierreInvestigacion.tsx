...
/**
 * Cierre — la ecuación de ED (Investigación + Acción + Reflexión + Alianzas =
 * Transformación) que se arma término por término con el scroll (tipografía
 * cinética, sin líneas). Suma la fusión con el footer (data-footer-dock-dark:
 * muesca navy) + los puntos §6 difuminados hacia el pie + la luz del faro, para
 * cerrar coherente con el resto. CTA naranja → Contacto.
 */
export function CierreInvestigacion() {
  ...
  return (
    <section
      ...
      className="bg-azul-principal relative z-50 -mt-[5svh] overflow-hidden rounded-t-[2.5rem] text-white"
      aria-label="Cierre"
    >
      {/* Puntos §6 difuminados hacia el pie (para que la fusión con el footer
          quede sin costura) + luz del faro + halo verde. */}
      <span
        aria-hidden="true"
      ...
      <div className="relative z-10 mx-auto w-full max-w-screen-xl px-5 py-28 text-center md:px-10 md:py-36">
        <div
          data-ecuacion

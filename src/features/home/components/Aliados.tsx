...
export function Aliados() {
  return (
    ...
    >
      ...
      <span
        aria-hidden="true"
        className="absolute right-28 bottom-24 hidden h-44 w-44 bg-[radial-gradient(circle,var(--pattern-dot-blue)_1px,transparent_1px)] [background-size:14px_14px] md:block"
      />
      <span
        aria-hidden="true"
